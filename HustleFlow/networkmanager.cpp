...
NetworkManager::NetworkManager(int index, const QJsonObject & obj, QWidget *parent) : QWidget(parent)
{
    // -- NEWS URL --
    ...
    connect(button, &QPushButton::clicked, this, &NetworkManager::OnViewClicked);
}

// == PRIVATE SLOTS ==

void NetworkManager::OnViewClicked()
{
