...
#include <memory>
#include "../HustleFlow/constants.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Constants_t, stringdata0) + ofs), len 
...
const QMetaObject Constants::staticMetaObject = { {
    QMetaObject::SuperData::link<QDeclarativeItem::staticMetaObject>(),
    qt_meta_stringdata_Constants.offsetsAndSize,
